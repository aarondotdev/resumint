import type { CertificatesSection, CertificateEntry } from "@/lib/types";
import { createCertificateEntry } from "@/lib/defaults";
import { Plus, Trash2 } from "lucide-react";
import EntryControls from "./entry-controls";

interface Props {
  section: CertificatesSection;
  onChange: (section: CertificatesSection) => void;
}

export default function CertificatesEditor({ section, onChange }: Props) {
  function updateEntry(idx: number, patch: Partial<CertificateEntry>) {
  ...
  function addEntry() {
    onChange({ ...section, entries: [...section.entries, createCertificateEntry()] });
  }
