...
import { createExperienceEntry } from "@/lib/defaults";
...
export default function ExperienceEditor({ section, onChange }: Props) {
  function updateEntry(idx: number, patch: Partial<ExperienceEntry>) {
  ...
  function addEntry() {
    onChange({ ...section, entries: [...section.entries, createExperienceEntry()] });
  }
